...
## DMS Notebooks included in the repository:
 - [DMS_analysis](DMS_analysis): details the pipeline to go from the MiSEQ fastq file to relative abudances of each FCY1 codon level variant at each timepoints
